...
import spacy
import json
from .Milestone2.course_info import get_info
from .Milestone2.course_info.get_info import Course
def hasclass(question):
    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    DIR = os.path.join(os.path.dirname(BASE_DIR), 'FIT_QA_SYSTEM/QA/Milestone2/course_info/courses.txt')
    get_info.main()
    courses = pickle.load(open(DIR, "rb"))
    nlp = spacy.load("en")
...
def hasfaculty(question):
    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    DIR = os.path.join(os.path.dirname(BASE_DIR), 'FIT_QA_SYSTEM/QA/data/department_staff_json.json')
...
def hasbuilding(question):
    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    DIR = os.path.join(os.path.dirname(BASE_DIR), 'FIT_QA_SYSTEM/QA/data/buildings.json')
    with open(DIR, 'r') as f:
        data = json.load(f)
